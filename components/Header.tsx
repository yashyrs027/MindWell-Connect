      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center">
            ...
            <button
              onClick={onLogout}
              className="ml-4 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 text-slate-600 bg-slate-100 hover:bg-red-100 hover:text-red-700"
            >
              Logout
            </button>
          </div>
